...
CraftDialog::CraftDialog(Personazh* p, QWidget* parent, int imageMode)
    ...
    // Подсказка
    QLabel* hintLabel = new QLabel("Ctrl+S — сохранить карточку на рабочий стол");
    ...
    connect(saveShortcut, &QShortcut::activated, this, [=]() {
        ...
        QString filename = desktopPath + "/Карточка_" + person->name + ".txt";
        ...
        if (file.open(QIODevice::WriteOnly)) {
            ...
            QMessageBox::information(this, "Успех", 
                QString("Карточка сохранена на рабочий стол!\n%1").arg(filename));
        } else {
